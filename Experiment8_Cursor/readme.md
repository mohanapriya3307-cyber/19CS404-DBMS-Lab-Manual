...
INSERT INTO employees VALUES (103, 'Karthik', 'Tester');
COMMIT;
DECLARE
...
```
**Output:** 
<img width="601" height="231" alt="image" src="https://github.com/user-attachments/assets/03d22b5d-a876-43cc-a32f-20c034b49e7b" />
...
UPDATE employees SET salary = 35000 WHERE emp_id = 103;
COMMIT;
SET SERVEROUTPUT ON;
DECLARE
 ...
 v_name employees.emp_name%TYPE;
    ...
    v_count NUMBER := 0;
    min_salary NUMBER := 40000;
    max_salary NUMBER := 60000;
BEGIN
    OPEN emp_cursor(min_salary, max_salary);
    LOOP
...
```
**Output:** 
<img width="613" height="255" alt="image" src="https://github.com/user-attachments/assets/e3e757ea-11eb-4361-9525-fcac63ea0c00" />
...
<img width="595" height="271" alt="image" src="https://github.com/user-attachments/assets/9d45c473-550d-489f-872d-11eab6f99599" />
...
INSERT INTO employees VALUES (103, 'Karthik', 'Tester', 35000);
COMMIT;
SET SERVEROUTPUT ON;
DECLARE
    CURSOR emp_cursor IS
...
<img width="601" height="722" alt="image" src="https://github.com/user-attachments/assets/a32571e7-c323-4360-9a33-419fb9204d17" />
...
INSERT INTO employees VALUES (102, 'Priya', 'Developer', 45000, 20);
INSERT INTO employees VALUES (103, 'Karthik', 'Tester', 35000, 10);
INSERT INTO employees VALUES (104, 'Divya', 'Developer', 50000, 20);
COMMIT;
SET SERVEROUTPUT ON;
DECLARE
    CURSOR emp_cursor IS
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('Error: No employees found in the specified department.');
        ROLLBACK;
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Unexpected Error: ' || SQLERRM);
        ROLLBACK;
...
<img width="591" height="271" alt="image" src="https://github.com/user-attachments/assets/69f931d2-968f-452d-892c-4003430fdfab" />
